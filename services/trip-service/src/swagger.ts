      ...
      schemas: {
        Trip: {
          ...
          properties: {
            ...
            destinationLatitude: { type: "number", format: "double", example: 48.85341 },
            destinationLongitude: { type: "number", format: "double", example: 2.3488 },
            destinationTimezone: { type: "string", example: "Europe/Paris" },
            destinationCountryCode: { type: "string", example: "FR" },
